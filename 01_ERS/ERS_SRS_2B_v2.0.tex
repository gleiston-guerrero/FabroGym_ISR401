...
\textbf{Excepción \texttt{CU-04-EX-01}.} \textit{Condición de disparo:} No existe coincidencia o la información solicitada queda fuera del alcance permitido para el rol.
\begin{enumerate}[label=\alph*.]
...
\textbf{Excepción \texttt{CU-08-EX-01}.} \textit{Condición de disparo:} El cliente no existe o el criterio de búsqueda es inválido.
\begin{enumerate}[label=\alph*.]
