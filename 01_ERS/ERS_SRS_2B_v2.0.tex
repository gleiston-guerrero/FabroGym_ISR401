...
Fecha de corte documental & 1 de septiembre de 2026 \\\hline
...
2.0 & 2026-09-01 & Cierre 2B terminal: 25 RF, 23 RNF, 4 restricciones de diseño y 105 filas de trazabilidad (97 trazas preexistentes migradas y 8 planes de verificación del componente inteligente); integración de 16 sesiones, encuesta de 70 respuestas, análisis reproducible y OSF v1.4.\\
...
\subsection{Saturación y límite estadístico}
...
La encuesta de 70 respuestas no contiene perfil técnico/no técnico ni ítems Likert de explicabilidad por dimensión. En consecuencia, no se calculan Mann--Whitney, Fleiss $\kappa$ ni una satisfacción Likert de explicabilidad con datos inexistentes. El análisis cuantitativo de la encuesta permanece descriptivo, conforme a las propiedades reales del instrumento \cite{molleri2020,cohen1988}.
...
\begin{tabularx}{\textwidth}{|>{\bfseries}p{4.0cm}|X|}\hline
Enunciado & Toda rutina asignada o propuesta deberá indicar si ha sido revisada o validada por un entrenador autorizado y, cuando exista una indicación profesional externa registrada, identificar dicha procedencia como contexto relevante de la rutina. \\ \hline
Qué se explica & Revisión humana de la rutina y procedencia profesional externa cuando aplique. \\ \hline
A quién & Cliente e instructor autorizado. \\ \hline
Formato & Etiqueta de estado y texto breve de procedencia en la cabecera de la rutina. \\ \hline
Momento & Antes de que la rutina sea utilizada por el cliente. \\ \hline
Métrica & Porcentaje de rutinas asignadas o propuestas que muestran su condición de revisión y la procedencia profesional externa cuando exista. \\ \hline
Unidad & Porcentaje. \\ \hline
Umbral & 100\% de las rutinas evaluadas deben indicar su condición de revisión; cuando exista una indicación profesional externa registrada, su procedencia debe ser visible. \\ \hline
Método de comprobación & Pruebas funcionales con rutinas revisadas/no revisadas y casos con indicación profesional externa, verificando la información visible. \\ \hline
...
Supervisión humana & RNF-17 & 100\% de rutinas con estado de revisión y procedencia visible; PV-RNF-17. \\
...
La matriz externa \texttt{04\_Trazabilidad/matriz\_trazabilidad.csv} contiene 105 filas: 97 trazas preexistentes migradas y 8 planes de verificación asociados al componente inteligente. Cada fila relaciona fuente/ley, objetivo, stakeholder, evidencia, requisito, CU, HU, CA, componente y mockups. La figura resume el encadenamiento utilizado.
...
El análisis 2B dispone de una entrada única \texttt{06\_Experimento/scripts\_analisis/run\_all.py} y tablas/figuras regenerables desde datos crudos/procesados. Toda cifra cuantitativa usada por la ERS debe mantenerse sincronizada con esa salida \cite{sandve2013,wilkinson2016}.
