...
|---|---|---|
| **Mera Arias Erick Jhair (`Emeraxs`)** | Corrección textual de §4; sincronización de `run_all.py`; política y normalización LF; verificación reproducible del pipeline; análisis técnico de WALK-TEC-01; retiro/verificación de capturas A2 observadas; limpieza de duplicados de Alvia; actualización del corte documental del ERS y recompilación de entregables; sincronización final de materiales de defensa; actualización documental de autoría/retrospectiva; refinamiento final de CU-04 y CU-08; LF explícito en el cálculo de Kappa y actualización de la retrospectiva canónica. | `1dd541b`, `53d17a0`, `318f4eb`, `d995cdb`, `0bf5014`, `bf82034`, `ce89a2b`, `3e16b35`, `e7668ef`, `08d4bf9`, `4b7d617`, `5393892`, `5448602`, `30c7c5c`. |
| **Ponce Rivera Mery Helenmey (`Mery-003`)** | Sincronización de trazabilidad de §4; LF en scripts auxiliares; documentación de cadena canónica; cierre documental de WALK-TEC-01; consolidación documental A2 y retrospectiva; corrección de SHA-256 de Vaca; consolidación de README/CHANGELOG/FAIR/publicación; cierre del manifiesto de defensa y trazabilidad; sincronización de CU-04/CU-08 en la matriz; documentación de `EV-VAL-01` y consolidación del microsaneamiento final pre-verificación. | `0d42923`, `6a68f3c`, `6244ea8`, `ab8d897`, `fccdb9d`, `37f02ac`, `d52ca17`, `7eb007e`, `59cbd82`, `fbaf9b3`, `3b437a1`, `8ed19c7`. |
