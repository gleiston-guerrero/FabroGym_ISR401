...
**Etiqueta de cierre declarada para la entrega terminal:** `v2.0.2-final`
...
La corrección preserva la autoría histórica y separa esa autoría de la composición del equipo que rinde el examen final. Para este corte, el equipo de cierre está formado por:

- **Mera Arias Erick Jhair** — `Emeraxs`;
- **Mora Duarte Alex José** — `amorad35`;
- **Ponce Rivera Mery Helenmey** — `Mery-003`.

Alvia Villegas Erick Adalberto y Vaca Romero David Octavio permanecen como contribuyentes históricos en los artefactos donde corresponde. No se les reasignan ni fabrican evidencias del corte actual. La delimitación canónica se encuentra en `10_Autoria/EQUIPO_EXAMEN_FINAL.md`.

## 2. Correcciones ejecutadas

| Sección | Hallazgo de revisión | Corrección terminal | Evidencia principal | Responsable documentado |
|---|---|---|---|---|
| §15 Autoría | La evidencia del corte podía confundirse con la autoría histórica y el inventario fotográfico requería normalización. | Se delimitó el equipo actual a Mera, Mora y Ponce sin borrar aportes históricos; se consolidaron A2, fotografías reales y EXIF. | `10_Autoria/EQUIPO_EXAMEN_FINAL.md`, `10_Autoria/capturas/README.md`, `10_Autoria/README_A11_EXIF.md`, `10_Autoria/exif_inventario.csv` | **Ponce Rivera / `Mery-003`**, corrección registrada en `efa727f`. |
...
| §16 Informe | El informe no reunía en un único artefacto la tabla corregida, la limitación del cuestionario, la explicación ética, la línea base declarada y una retrospectiva con responsables. | El manuscrito integra esos elementos y se recompila desde la fuente. | `07_Publicacion/manuscrito_final.tex`, `07_Publicacion/manuscrito_final.pdf`, `07_Publicacion/compilar_manuscrito.py` | **Mera, Mora y Ponce**, revisión cruzada del informe de cierre. |
