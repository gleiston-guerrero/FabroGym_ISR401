...
\S15 & Closure documentation had mixed historical five-person authorship with the current examination team; the photographic inventory also required normalization. & Historical authorship is preserved, while the current closure/examination team is explicitly Mera, Mora, and Ponce. Existing evidence is reported as it exists; missing historical evidence is not reconstructed or retroactively fabricated. & Repository-side documentation only; unresolved evidence requirements remain subject to the separate \S15 closure and are not represented here as newly created evidence. \\
