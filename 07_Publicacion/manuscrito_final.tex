...
The corrective pass was treated as an auditable closure exercise rather than as an opportunity to rewrite the historical record. Historical authorship remains preserved in Git, the ERS/SRS, and the published research artifacts. For the suspended-exam evaluation, the evaluated team is Mera Arias Erick Jhair and Ponce Rivera Mery Helenmey. Mora Duarte Alex Jos{\'e} may support the closure as a non-evaluated collaborator, and any contribution he makes remains attributed to his own Git identity. Alvia Villegas Erick Adalberto and Vaca Romero David Octavio remain credited for their historical contributions where those contributions actually occurred and do not continue in this examination stage. The composition change is formalized in \path{04_Trazabilidad/solicitud_cambio_composicion_equipo.pdf}, and the canonical scope statement is \path{10_Autoria/EQUIPO_EXAMEN_FINAL.md}.
...
\S15 & Closure documentation had mixed historical five-person authorship with the current examination team; the photographic inventory also required normalization. & Historical authorship is preserved. For this suspended-exam evaluation, Mera and Ponce are the evaluated members; Mora is a non-evaluated collaborator whose contributions remain under his own identity, while Alvia and Vaca retain only their historical attribution for this stage. The composition change is formalized in \path{04_Trazabilidad/solicitud_cambio_composicion_equipo.pdf}. Existing evidence is reported as it exists; missing historical evidence is not reconstructed or retroactively fabricated. & Repository-side documentation aligned with \path{10_Autoria/EQUIPO_EXAMEN_FINAL.md}; no contribution is reassigned between authors. \\
